...
<div class="box">
	<h3>添加房屋信息</h3>
	<form action="<c:url value='/house/add'/>" method="post">
	<table class="form-table">
		<tr>
			...
			<tr>
				...
				<td colspan="3" class="control">
					<select name="hdeco">
						<option value="1" selected>精装</option>
			...
			<tr>
				<td>是否双气</td>
				<td colspan="3" class="control">
					<input type="radio" name="hair" value="1" checked >是
					<input type="radio" name="hair" value="2" checked >否
				</td>
			</tr>
			<tr>
				<td>出租价格（元/月）</td>
			...
			<tr>
				...
				<td colspan="3" class="control">
					<select name="hrentStatus">
						...
						<option value="2" selected>待出租</option>
						<option value="3" selected>未出租</option>
					</select>
				</td>
			</tr>
			<tr>
